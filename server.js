...
app.put('/update-plan', function(req,res){
    console.log('this is plan_time: ', req.body.plan_time);

    connection.query('UPDATE plans SET plan_time = ? WHERE id = ?', [req.body.plan_time, req.body.id], function(err, result) {
      if (err) throw err;
      res.redirect('/');
    });
});
